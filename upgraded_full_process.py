...
MODEL_DIR = os.path.join('C:\\Users\\user\\Documents\\BE_Experience_Workplace', "logs")

# Local path to trained weights file
COCO_MODEL_PATH = os.path.join('C:\\Users\\user\\Documents\\System_in_Administrator\\Libraries', "mask_rcnn_coco.h5")
...
output_dir = 'C:\\Users\\user\\Documents\\BE_Experience_Workplace\\original_files'
processed_dir = 'C:\\Users\\user\\Documents\\BE_Experience_Workplace\\modified_files'
...
processed_paths = [os.path.join(processed_dir, f'processed_video{i+1}.mp4') for i in range(len(urls))]
segmented_paths = [os.path.join(processed_dir, f'segmented_video{i+1}.mp4') for i in range(len(urls))]
